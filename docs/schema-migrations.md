...
| Source state/discovery/run | schema 1 | schema 1 | unchanged in this foundation |
...
For Git-native files, rollback is the prior commit. A future SQLite migration writes a new database and swaps it after validation. Parquet migrations write versioned partitions before changing their manifest.
